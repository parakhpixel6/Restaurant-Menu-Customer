var chineseArr = [
    {
        img: './assets/customer-img/img/fried-rice.png',
        name: 'Fried Rice',
    ...
    {
        img: './assets/customer-img/img/grilled-calamarti.png',
        name: 'Grilled Calamarti',
        veg_NonVeg_Img: './assets/customer-svg/svg/Non-veg.svg',
        tasteImg: './assets/customer-svg/svg/Gluten-Free.svg',
        tasteText: 'Gluten Free',
        ratingImg: './assets/customer-svg/svg/5 star.svg',
...
var half1 = chineseArr.slice(0, Math.ceil(chineseArr.length / 2));
var half2 = chineseArr.slice(Math.ceil(chineseArr.length / 2));
...
document.querySelector('#chinesePg1').innerHTML = clutter1;
document.querySelector('#chinesePg2').innerHTML = clutter2;
