var continentalArr = [
    {
        img: './assets/customer-img/img/kara-kuzhambu.png',
        name: 'Kara Kuzhambu',
    ...
    {
        img: './assets/customer-img/img/sushi.png',
        name: 'Asian Sushi',
        veg_NonVeg_Img: './assets/customer-svg/svg/Veg.svg',
        tasteImg: './assets/customer-svg/svg/Gluten-Free.svg',
        tasteText: 'Gluten Free',
    ...
    {
        img: './assets/customer-img/img/ratatouille.png',
        name: 'Ratatouille',
    ...
    {
        img: './assets/customer-img/img/quiche-lorraine.png',
    ...
    {
        img: './assets/customer-img/img/caeser-salad.png',
        name: 'Caeser Salad',
        veg_NonVeg_Img: './assets/customer-svg/svg/veg.svg',
        tasteImg: './assets/customer-svg/svg/Vegan.svg',
        tasteText: 'Vegan',
...
var half1 = continentalArr.slice(0, Math.ceil(continentalArr.length / 2));
var half2 = continentalArr.slice(Math.ceil(continentalArr.length / 2));
...
document.querySelector('#continentalPg1').innerHTML = clutter1;
document.querySelector('#continentalPg2').innerHTML = clutter2;
