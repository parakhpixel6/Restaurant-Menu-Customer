var northIndianArr = [
    {
        img: './assets/customer-img/img/butter-chicken.png',
        name: 'Butter Chicken',
    ...
    {
        img: './assets/customer-img/img/naan.png',
        name: 'Garlic Naan',
        veg_NonVeg_Img: './assets/customer-svg/svg/Veg.svg',
        tasteImg: './assets/customer-svg/svg/Gluten-Free.svg',
        tasteText: 'Gluten Free',
    ...
    {
        img: './assets/customer-img/img/dum-aloo.png',
        name: 'Dum Aloo',
    ...
    {
        img: './assets/customer-img/img/tandoori-chicken.png',
...
var half1 = northIndianArr.slice(0, Math.ceil(northIndianArr.length / 2));
var half2 = northIndianArr.slice(Math.ceil(northIndianArr.length / 2));
...
document.querySelector('#northIndianPg1').innerHTML = clutter1;
document.querySelector('#northIndianPg2').innerHTML = clutter2;
